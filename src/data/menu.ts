...
export const menuData: MenuCategory[] = [
  {
    ...
    items: [
      ...
      {
        id: "beet_carpaccio",
        name: "items.beet_carpaccio.name",
        description: "items.beet_carpaccio.description",
      },
      {
        id: "salmon_tartare",
        name: "items.salmon_tartare.name",
        description: "items.salmon_tartare.description",
      },
      {
        id: "tuna_tartare",
        name: "items.tuna_tartare.name",
        description: "items.tuna_tartare.description",
      },
      {
        id: "beef_tartare",
        name: "items.beef_tartare.name",
        description: "items.beef_tartare.description",
      },
      {
        id: "bruschetta_burrata",
        name: "items.bruschetta_burrata.name",
        description: "items.bruschetta_burrata.description",
      },
      {
        id: "bbq_chicken_wings",
        name: "items.bbq_chicken_wings.name",
        description: "items.bbq_chicken_wings.description",
      },
      {
        id: "tempura_shrimp",
        name: "items.tempura_shrimp.name",
        description: "items.tempura_shrimp.description",
      },
      {
        id: "veggie_spring_rolls",
        name: "items.veggie_spring_rolls.name",
        description: "items.veggie_spring_rolls.description",
      },
      {
        id: "shrimp_spring_rolls",
        name: "items.shrimp_spring_rolls.name",
        description: "items.shrimp_spring_rolls.description",
      },
      {
        id: "falafel_tahini",
        name: "items.falafel_tahini.name",
        description: "items.falafel_tahini.description",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "carbonara_pasta",
        name: "items.carbonara_pasta.name",
        description: "items.carbonara_pasta.description",
      },
    ],
  },
  {
